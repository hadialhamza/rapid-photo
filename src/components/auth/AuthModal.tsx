      ...
      {isOpen && (
        <div className="fixed inset-0 z-100 flex items-center justify-center p-4 sm:p-6">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md bg-surface/80 border border-border shadow-2xl rounded-3xl p-8 flex flex-col backdrop-blur-xl z-10"
          >
            {/* Close Button */}
            <button
              onClick={closeModal}
              className="absolute top-6 right-6 p-2 text-muted hover:text-foreground hover:bg-elevated rounded-full transition-all duration-300"
            >
              <X className="w-5 h-5" />
            </button>
